...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if($request->get('email')){
            ...
            if($user){
                // 1 : Enregistrer en base la demande de réinitialisation de mot de passe dans reset_password
                ...
                // 2 : Envoyer un email à l'utilisateur lui permettant de mettre à jour sont mot de passe
    ...
    public function update(Request $request, $token, UserPasswordEncoderInterface $encoder): Response
    {
        ...
        // Rendre vue avec mot de passe et confirmer mot de passe.
